...
describe('PII Masking', () => {
    it('should mask Chinese ID card numbers', async () => {
        ...
        expect(result.detected.some((d) => d.type === 'ID_CARD')).toBe(true);
    });
...
describe('Compliance Check', () => {
    it('should detect credit scoring as high risk', async () => {
        ...
        expect(result.annex_categories.some((c) => c.id === 'credit')).toBe(true);
    });
    it('should detect healthcare as high risk', async () => {
        ...
        expect(result.risk_level).toBe('high');
        expect(result.annex_categories.some((c) => c.id === 'healthcare')).toBe(true);
    });
